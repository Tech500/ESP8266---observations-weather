...
//
//                       "NTP_Observations_SPIFFS.ino"    --with webInterface  01/09/2018 04:44 EST --ab9nq.william--at-gmail.com
//
//                       Modified Wifi mode
//
...
#define LISTEN_PORT           8002  // in-place of yyyy put your listening port number
				...
				error =0;
                    ...
                    if (strcmp(action, "GET") == 0)
                    {
						...
						readFile();
                         ...
                         // Check the action to see if it was a GET request.
                         else  if(strncmp(path, "/zzzzzzz", 7) == 0)   //replace "/zzzzzzz" with your choice.  Makes "ACCESS.TXT" a restricted file.  Use this for private access to remote IP file.
                              //
                         {
...
void setClockWithNTP()
{
 ...
 void webInterface()
 {
	...
	{   //Check WiFi connection status
		...
		http.begin("http://YourDomainWebSite/DestinationFolder/dataCollector.php");      //Specify request destination
